...
**Why:** the flash port transcribed most of Einstein's
...
## Guest tests for hypervisor features
...
## Finish-the-task semantics

When the user says "do everything known to be necessary for X",
land every item on the known-required checklist. Don't:
