...
//! pen-down edge so [`crate::host::host_io::queue::enqueue_pen_sample`] sees
...
//! [`pump`] → [`crate::host::host_io::queue`] → guest IRQ. The host-io
...
pub(crate) fn drain_into_queue<P: PenSource>(src: &mut P) -> bool {
    ...
    use crate::host::host_io::{pack_pen_sample, queue, PEN_DOWN_SAMPLE_MARKER, PEN_UP_SAMPLE_MARKER};
