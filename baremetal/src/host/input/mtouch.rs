...
use crate::kprintln;
use crate::host::usb::class::hid;
use crate::host::usb::enumerate::{self, EndpointDescriptor, UsbDevice};
use crate::host::usb::host::{dwc2, UsbHostController};
use crate::host::usb::UsbError;
...
fn init() {
    ...
    match r {
        Ok(()) => {
            ...
            crate::host::platform::enable_bcm2835_irq(9);
...
fn attach<H: crate::host::usb::host::UsbHostController>(
    host: &mut H,
    dev: &UsbDevice,
) -> crate::host::usb::UsbResult<()> {
