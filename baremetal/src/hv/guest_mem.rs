...
pub unsafe fn load_guest_test() {
    ...
    unsafe {
        crate::newton::guest_trampolines::patch_und_vector(addr_of_mut!(GUEST_ROM) as *mut u32);
    }
...
pub unsafe fn load_newton_rom() {
    ...
    unsafe { crate::newton::rom_patches::apply_717006_patches(rom_ptr); }
    ...
    unsafe { crate::newton::guest_trampolines::patch_und_vector(rom_ptr); }

    // Install the DABT-vector intercept. See
    // `guest_trampolines::patch_dabt_vector`.
    unsafe { crate::newton::guest_trampolines::patch_dabt_vector(rom_ptr); }
