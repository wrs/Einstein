...
pub use imp::{
    ...
    FDATE_FROM_SECONDS, INSN_AS_DATA_LDRS, FPE_LDRS, STORE_PROBES,
...
const _: () = {
    ...
    let _ = (&REAL_CLOCK_SECONDS, &FTIME_IN_SECONDS, &FDATE_FROM_SECONDS);
    let _ = (&INSN_AS_DATA_LDRS, &FPE_LDRS, &STORE_PROBES);
