...
//!     (`uart::on_tx_done`), the audio MAI ring + stereo ring tail +
...
//! act, not an accident.
//!
//! The leaf consumers (`uart::on_tx_done`, `audio::on_mai_dma_done`,
...
//!
//! [`cpu::with_irqs_unmasked`]: crate::cpu::with_irqs_unmasked
//! [`trap::irq_from_el2`]: crate::trap
//! [`trap::trap_irq`]: crate::trap::trap_irq
//! [`timer::on_irq`]: crate::timer::on_irq
//! [`platform::dispatch_dma_completions`]: crate::platform::dispatch_dma_completions
...
impl IrqCap {
    ...
    /// # Safety
    ///
    /// Call this from exactly one place — [`crate::trap::trap_irq`], the
